...
module Cat.Depreciated.Virtual.Product where
...
open import Cat.Depreciated.Virtual
...
## Product of `Cat.Depreciated.Type` categories
...
`Cat.Depreciated.Type.category` hits the same coherence problem; it would
