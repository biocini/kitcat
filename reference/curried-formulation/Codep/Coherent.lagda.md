...
The Route-B `op-axioms` (definitional fibre center, `Cat.Depreciated.Codep.Op`) is
...
module Cat.Depreciated.Codep.Coherent where
...
(`Cat.Depreciated.Codep.Op`), the op extraction is definitionally the base
