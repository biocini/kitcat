...
module Cat.Depreciated.Monoidal.Braid where
...
open import Cat.Depreciated.Iso using (idtoiso)
...
mirroring `⊗-associator` in `Cat.Depreciated.Monoidal.Iso`. Invertibility is
