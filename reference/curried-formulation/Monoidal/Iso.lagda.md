...
`Cat.Depreciated.Monoidal.Bifunctor` as dependent paths of 2-cells — reads
...
open import Cat.Depreciated.Monoidal.Bifunctor using (assoc-nat; unitl-nat; unitr-nat)
open import Cat.Depreciated.Base using (module Cat)
open import Cat.Depreciated.Iso using (idtoiso; hom-PathP→square)
