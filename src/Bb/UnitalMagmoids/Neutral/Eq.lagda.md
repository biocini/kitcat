...
import Bb.UnitalMagmoids.Base as M
import Bb.UnitalMagmoids.Neutral as N

module Bb.UnitalMagmoids.Neutral.Eq (M : magmoids) where
...
`Bb.UnitalMagmoids.Base` are recoverable: mediality
wraps to segal thunkability, and right-associativity wraps to segal
linearity.
