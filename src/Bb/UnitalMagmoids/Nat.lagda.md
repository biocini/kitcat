...
module Bb.UnitalMagmoids.Nat (M N : magmoids) where
...
open import Bb.UnitalMagmoids.Map

import Bb.UnitalMagmoids.Base
import Bb.UnitalMagmoids.Neutral as Neu

private
  module C = Bb.UnitalMagmoids.Base M
  module D = Bb.UnitalMagmoids.Base N
