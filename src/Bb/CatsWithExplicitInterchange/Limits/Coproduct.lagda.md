...
Coproducts over a `Bb.CatsWithExplicitInterchange.Type` category.
...
module Bb.CatsWithExplicitInterchange.Limits.Coproduct where
...
open import Bb.CatsWithExplicitInterchange.Limits.Product
