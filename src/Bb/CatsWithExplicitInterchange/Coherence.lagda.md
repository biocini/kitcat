...
module Bb.CatsWithExplicitInterchange.Coherence where
...
module _ {o h} (C : category o h) where
  ...
  -- only form of the straightening lives in Bb.CatsWithExplicitInterchange.Coherence.Gloss.
  nrm-slide
...
faces live in `Bb.CatsWithExplicitInterchange.Coherence.Gloss`.
