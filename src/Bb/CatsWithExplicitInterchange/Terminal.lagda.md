...
The terminal category, as a `Bb.CatsWithExplicitInterchange.Type`
category.
...
module Bb.CatsWithExplicitInterchange.Terminal where
...
```agda
open import Bb.CatsWithExplicitInterchange.Limits.Terminal
