...
winding of the derived unitor discrepancy in `Test.CircleTensor`.
...
module Test.CircleUnitorTwist where
...
open import Cat.Depreciated.Monoidal.Properties using (ω-vanish-l)

open import HData.Circle
open Circle

open import Test.CircleTensor using (Circle-tensor; routes-differ)
