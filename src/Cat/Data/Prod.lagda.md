...
We show `yon-prod` is an embedding. The key step is an equivalence
between paths of product morphisms and paths of product Yoneda
functions, built from the component Yoneda embeddings.
