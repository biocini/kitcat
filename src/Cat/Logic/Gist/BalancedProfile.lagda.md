...
module Cat.Logic.Gist.BalancedProfile where
...
open import Cat.Logic.Gist.BalancedBase
```
...
module attempt₁ where
  ...
  P .virtual-graph.twist⁻ _ = ⋆
  P .virtual-graph.readback (inl m) = refl
  P .virtual-graph.readback (inr t) = refl
...
module attempt₂ where
  ...
  Q .virtual-graph.twist⁻ _ = π₁
  Q .virtual-graph.readback (false , false) = refl
  Q .virtual-graph.readback (false , true)  = refl
  Q .virtual-graph.readback (true , d)      = refl
