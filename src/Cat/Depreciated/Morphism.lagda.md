...
Morphism-level algebra over a `Cat.Depreciated.Type` category: whiskering,
sections and retractions, monomorphisms and epimorphisms, and
neutrality — composition maps being equivalences.

```agda
{-# OPTIONS --safe --erased-cubical --no-guardedness #-}

module Cat.Depreciated.Morphism where
