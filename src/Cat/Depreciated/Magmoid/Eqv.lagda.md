...
import Cat.Depreciated.Magmoid.Unit as U
import Cat.Depreciated.Magmoid.Iso as I

module Cat.Depreciated.Magmoid.Eqv (M : magmoids) (u : ∀ x → N.unital M x) where
...
open import Cat.Depreciated.Magmoid.Base M hiding (assoc)
open N M
