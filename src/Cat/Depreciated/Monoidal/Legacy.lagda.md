...
module Cat.Depreciated.Monoidal.Legacy where
...
Token-for-token transcription of `Cat.Depreciated.Type.representable`
...
The transcription of `Cat.Depreciated.Base.theory`. The contractible spine
...
The frames are quantified *visibly*, as `Cat.Depreciated.Type` keeps the
