...
(`Cat.Depreciated.Monoidal.Legacy.Braid`), but the hexagon is not: the two braid
...
module Cat.Depreciated.Monoidal.Legacy.Hexagon where
...
open import Cat.Depreciated.Monoidal.Legacy
open import Cat.Depreciated.Monoidal.Legacy.Bifunctor
open import Cat.Depreciated.Monoidal.Legacy.Coherence
open import Cat.Depreciated.Monoidal.Legacy.Braid
```
