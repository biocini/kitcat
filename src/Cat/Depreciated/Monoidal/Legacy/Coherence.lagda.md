...
2-coherence of the tensor: the transcription of `Cat.Depreciated.Coherence`
...
module Cat.Depreciated.Monoidal.Legacy.Coherence where
...
`Cat.Depreciated.Coherence`'s `is-2-coherent`, and the morphism level
