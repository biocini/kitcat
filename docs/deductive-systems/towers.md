...
Each action distributes over its own hand's composition — the
representation witness read at that hand's axiom half:
...
framing itself still free — each hand gains exactly **one** unit law, and
the edge it gains is the *other* hand's twist:
...
is unique, and that is the whole of the coherence. The term tower is the
