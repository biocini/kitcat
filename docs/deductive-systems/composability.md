...
The opposite's coterm-hand composite is the term-hand composite of the
...
[towers.md](towers.md): distributivity of each action over its own hand's
composition, associativity for both, one unit law per hand, and the
