...
Audit the formalization against its informal source for: $@
...
1. **Toolchain** — Resolve the toolchain block (`TOOLCHAIN.md` at project root
   or a `## Toolchain` section in the project `AGENTS.md`). If absent, ask the
